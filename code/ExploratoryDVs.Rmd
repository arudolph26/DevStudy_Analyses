...
**But** it also showed that there is a lot of individual variabilitiy. The multilevel regression below with individual intercepts for each subject regressing the correct choices on age group and condition suggests that close to 40% variance is due to random effects. It also shows that the fixed effects are not signigicantly different for kids in any condition. 
