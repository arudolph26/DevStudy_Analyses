...
### EV and Variance effects on learning
...
Effect of variance: Since there isn't learning on average for the positive EV machines we only look at negative EV machines for an effect of variance on learning. We find (in the last two models below) variance does have an effect for negative EV machines. Children do not learn at all on average in the high var nEV machine.
...
Looking at learning effects separately:
