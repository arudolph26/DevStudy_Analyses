...
ave_pes = all_mods_pes %>%
  ...
  mutate(ave_PE = (`PE_Preds_Fit_alpha_neg-alpha_pos-beta-exp_Fix_lossave_`+`PE_Preds_Fit_alpha_neg-alpha_pos-beta-exp_neg-exp_pos_Fix_lossave_`+`PE_Preds_Fit_alpha-beta-exp_neg-exp_pos_Fix_lossave_`)/3)

write.csv(ave_pes, '/Users/zeynepenkavi/Dropbox/PoldrackLab/DevStudy_ServerScripts/ave_pes.csv', row.names=FALSE)
```
