...
exp_models = c("Fit_alpha_neg-alpha_pos-beta-exp_Fix_lossave_", "Fit_alpha_neg-alpha_pos-beta-exp_Fix_lossave_", "Fit_alpha_neg-alpha_pos-beta-exp_neg-exp_pos-lossave_Fix_", "Fit_alpha_neg-alpha_pos-beta-exp-lossave_Fix_", "Fit_alpha-beta-exp_neg-exp_pos_Fix_lossave_", "Fit_alpha-beta-exp_neg-exp_pos-lossave_Fix_" )
...
cor_df %>%
  ...
  mutate(med_cor_val = median(cor_val, na.rm=T),
         model_type = ifelse((var1 %in% exp_models)&(var2 %in% exp_models), "exp_exp", ifelse(!(var1 %in% exp_models)&!(var2 %in% exp_models), "alpha_alpha", "exp_alpha"))) %>%
  #exp_exp, alpha-alpha, "exp_alpha"
  ggplot(aes(reorder(cor_type,med_cor_val), cor_val, color=factor(model_type)))+
  geom_boxplot()+
