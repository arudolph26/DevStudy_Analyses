...
Can we think of this as a 'memory effect'? The more trials since the last time you have played, the more interference? 

For positive EV machines this is true for all groups.

For negative EV machines adults and teens continue to make correct choices even if a lot of trials have passed since they last played that machine. Kids don't seem to remember that the machine is 'bad' and are more likely to make an incorrect choice the longer it's been since they last played it.
